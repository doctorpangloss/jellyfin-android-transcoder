...
public sealed class FfmpegCommandTests
{
    ...
    public void RoutesHevcAndAv1Only()
    {
        ...
        try
        {
            ...
            Assert.True(RouteDecision.Decide(command, new MediaProbe("hevc", "yuv420p10le", "bt2020nc", "smpte2084", "bt2020")).Route);
            Assert.True(RouteDecision.Decide(command, new MediaProbe("av1", "yuv420p10le", "bt2020nc", "smpte2084", "bt2020")).Route);
            Assert.False(RouteDecision.Decide(command, new MediaProbe("h264", "yuv420p", "bt709", "bt709", "bt709")).Route);
        }
        finally
        {
            File.Delete(path);
